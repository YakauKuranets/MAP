...
class AdminUser(db.Model):
    ...
    created_at = db.Column(db.DateTime, nullable=False, default=_dt.utcnow)
...
class Incident(db.Model):
    ...
    events = db.relationship('IncidentEvent', backref='incident', lazy='joined', cascade='all, delete-orphan')
    assignments = db.relationship('IncidentAssignment', backref='incident', lazy='joined', cascade='all, delete-orphan')
